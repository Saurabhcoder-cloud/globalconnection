            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
                  ...
                  <li>Honor commitments made in purchase orders</li>
                  <li>Make payments according to agreed terms</li>
                  <li>Provide feedback and reviews honestly and fairly</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-base text-gray-600">
                  ...
                  <li>Deliver products as described and on schedule</li>
                  <li>Provide necessary documentation and certifications</li>
                  <li>Comply with all applicable export/import regulations</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-base text-gray-600 leading-relaxed">
                  We reserve the right to suspend or terminate your account at any time for violation of these terms, fraudulent activity, or any other reason we deem appropriate. You may terminate your account at any time by contacting our support team. Upon termination, your right to use the platform ceases immediately.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base text-gray-600 leading-relaxed">
                  We reserve the right to modify these terms at any time. Changes will be effective immediately upon posting to the platform. Your continued use of the platform after changes are posted constitutes acceptance of the modified terms. We encourage you to review these terms periodically.
                </p>
              </div>
